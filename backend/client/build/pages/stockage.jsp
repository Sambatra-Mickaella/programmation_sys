                                    ...
                                    <div class="row g-3">
                                        <div class="col-12 col-md-6">
                                            <div class="border rounded p-3 bg-body-tertiary">
                                                ...
                                                <div class="fs-5 fw-semibold text-primary"><%= stockageFormate %></div>
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            <div class="border rounded p-3 bg-body-tertiary">
                                                <div class="text-muted small">Disponible</div>
                                                <div class="fs-5 fw-semibold text-success"><%= stockageRestantFormate %></div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="d-flex justify-content-between mb-2">
                                                <small class="text-muted">Progression</small>
                                                <small class="fw-semibold"><%= pourcentage %>%</small>
                                            </div>
                                            <div class="progress">
                                                <div class="progress-bar <%= progressColor %>" role="progressbar" style="width: <%= pourcentage %>%;" aria-valuenow="<%= pourcentage %>" aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                            <div class="d-flex justify-content-between mt-2">
                                                <small class="text-muted"><%= stockageFormate %></small>
                                                <small class="text-muted"><%= quotaFormate %></small>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="d-flex justify-content-between">
                                                <span class="text-muted">Quota total</span>
                                                <span class="fw-semibold"><%= quotaFormate %></span>
                                            </div>
                                            <div class="d-flex justify-content-between mt-2">
                                                <span class="text-muted">Fichiers stockés</span>
                                                <span class="fw-semibold text-info"><%= nombreFichiers %></span>
                                            </div>
                                        </div>
                                    </div>
