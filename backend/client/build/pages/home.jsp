            ...
            <div class="card-body p-4 p-md-5">
                ...
                <form action="<%= request.getContextPath() %>/user" method="post">
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" name="nom" id="nom" placeholder="Votre nom..." autocomplete="username" required>
                    </div>
                    <div class="mb-4">
                        <label class="form-label" for="mdp">Mot de passe</label>
                        <input class="form-control" type="password" name="password" id="mdp" placeholder="Mot de passe" autocomplete="current-password" required>
                    </div>
                    <div class="d-grid">
