                ...
                <% String message=(String) request.getAttribute("message"); if (message !=null) { %>
                    ...
                    <% } %>
                        ...
                        <form class="row g-2 align-items-end mb-4" method="get"
                            action="<%= request.getContextPath() %>/show/mes_fichiers">
                            <div class="col-12 col-md-4">
                                <label class="form-label text-muted">Nom</label>
                                <input class="form-control" type="text" name="q" value="<%= request.getParameter(" q") !=null ?
                                    request.getParameter("q") : "" %>" placeholder="Rechercher...">
                            </div>
                            ...
                            <div class="col-6 col-md-2">
                                ...
                                <input class="form-control" type="number" name="min" min="0" value="<%= request.getParameter(" min")
                                    !=null ? request.getParameter("min") : "" %>">
                            </div>
                            <div class="col-6 col-md-2">
                                <label class="form-label text-muted">Taille max (octets)</label>
                                <input class="form-control" type="number" name="max" min="0" value="<%= request.getParameter(" max")
                                    !=null ? request.getParameter("max") : "" %>">
                            </div>
                                    ...
                                    <div class="card shadow-sm h-100">
                                        <div class="card-body d-flex flex-column">
                                            ...
                                            <div class="mt-auto d-flex gap-2">
                                                ...
                                                <a href="<%= request.getContextPath() %>/show/versions?file=<%= fileEncoded %>" class="btn btn-outline-secondary btn-sm"
                                                    title="Versions">
