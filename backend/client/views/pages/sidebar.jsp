    ...
    <div class="p-3 position-sticky top-0">
        <div class="card mb-3 shadow-sm">
            <div class="card-body py-3">
                <div class="fw-semibold">Bonjour, <%= user.getNom() %>
                </div>
                <div class="text-muted small">
                    <%= user.getNom() %>@example.com
                </div>
                </div>
                </div>
...
<div class="offcanvas offcanvas-start bg-body-tertiary" tabindex="-1" id="offcanvasSidebar">
    ...
    <div class="offcanvas-body d-flex flex-column">
        <nav class="nav nav-pills flex-column gap-1">
            ...
            <a class="nav-link <%= corbeilleActive %>" href="<%= request.getContextPath() %>/show/corbeille"><i
                    class="bi bi-trash-fill me-2"></i>Corbeille</a>
            ...
            <% if (user !=null && user.isAdmin()) { %>
                <a class="nav-link <%= adminActive %>" href="<%= request.getContextPath() %>/admin/dashboard"><i
                        class="bi bi-shield-lock-fill me-2"></i>Admin</a>
                <% } %>
                    <a class="nav-link <%= parametresActive %>" href="#" aria-disabled="true"><i
                            class="bi bi-gear-fill me-2"></i>Parametres</a>
        </nav>
